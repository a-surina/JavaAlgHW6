...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosInsert) + " milliseconds\n");

        moneyTree.insert(new Coin(7, "dinar", "gold"));
        moneyTree.insert(new Coin(2, "chervonets", "gold"));
        moneyTree.insert(new Coin(19, "rupee", "silver"));
        moneyTree.insert(new Coin(17, "dollar", "silver"));
        moneyTree.insert(new Coin(9, "thaler", "bronze"));
        ...
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosSearch) + " milliseconds\n");
        ...
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosDisplay) + " milliseconds\n");
        ...
        max.getCoin().printer();
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosMax) + " milliseconds\n");
        ...
        min.getCoin().printer();
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosMin) + " milliseconds\n");
